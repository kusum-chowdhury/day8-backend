...
async function main(skill) {
  ...
  //https://in.indeed.com/jobs?q=${skill}&l=Bangalore%2C+Karnataka&vjk=81f4f88fee57b7a8
  await page.goto(`https://in.indeed.com/jobs?q=${skill}&l=Bangalore%2C+Karnataka`, {
    timeout: 0,
